### Moved to backups folder. This version only had the base folium map w/ data CSVs loaded, and a test for downloading latest data CSV from a url - not able to do so with data sources we have, so has been scrapped.

# Renamed this file to 'Group34 Project Code', will need to add up to date version of our code here. 
# - Most up to date is 'folium_bore_implementation_test.py' - will merge here in place of all this after new tasks are completed and code is up-to-date. 
